...
1.  Import the .stl file for the fluid domain into Meshmixer
    ...
    <figure>
      <img class="svImg svImgLg" src="documentation/svfsi/fsi/imgs/opening_meshmixer.png">
    ...
    <figure>
      <img class="svImg svImgLg" src="documentation/svfsi/fsi/imgs/sculpting_figure.png">
    ...
    <figure>
      <img class="svImg svImgLg" src="documentation/svfsi/fsi/imgs/using_remeshing.png">
    ...
    <figure>
      <img class="svImg svImgLg" src="documentation/svfsi/fsi/imgs/using_smoothing.png">
...
2.  Extrude the fluid domain
    ...
    After the fluid domain surface has been sufficiently smoothed at all sharp corners and bifurcations, we are now ready to extrude out the wall surface.
      ...
      <figure>
          <img class="svImg svImgMd" src="documentation/svfsi/fsi/imgs/MM_fig_Extrude_Planecut1.png">
      </figure>
...
3.  Clean up the extruded surface
  ...
  - Smooth the post-extruded bifurcations using the same procedure as before.
    ...
    <figure>
      <img class="svImg svImgLg" src="documentation/svfsi/fsi/imgs/model_treatment_process.png">
    ...
    <figure>
      <img class="svImg svImgSm" src="documentation/svfsi/fsi/imgs/SV_Export_as_stl1.png">
    </figure>
