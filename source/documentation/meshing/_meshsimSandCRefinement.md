...
<figure>
<img class="meshGuideFigure" src="documentation/meshing/img/MeshSim_SRefinement_Options.png" width="60%">
</figure>

8)	Click on the "Create Sphere Refinement Macro" button. 
9)	The "Current List of Specified Meshing Parameters" should now show the sphere refinement macro. Ours is "sphereRefinement 0.05 3.0 1.088 3.290 -7.946".

Click the "SAVE OPTIONS" button at the top of the "Advanced Mesh Options" tab. Uncheck the slice planes in the "Volume Properties" tab.
...
<figure>
<img class="meshGuideFigure" src="documentation/meshing/img/MeshSim_Sphere_Refinement.png" width="60%">
</figure>
...
10)	Click on the "Create Cylinder Refinement Macro" button. 
 ...
 The "Current List of Specified Meshing Parameters" should now show the macro for cylinder refinement. The text in our case is "cylinderRefinement 0.05 2.0 3.0 0.150 2.490 -4.040 0.0 0.0 1.0". Click the "SAVE OPTIONS" button at the top of the “Advanced Mesh Options” tab. Uncheck the slice planes in the “Volume Properties” tab.
