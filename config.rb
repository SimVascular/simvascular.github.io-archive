...
["Installation", "QuickGuide", "ModelGuide", "Meshing", "FlowSolver", "svFSI", "svFSI-Fluid", "svFSI-Structure", "svFSI-CEP", "svFSI-FSI", "SimCardio", "ROMSimulation", "GenBC", "PythonInterface", "References", "Compile"].each do |name|
